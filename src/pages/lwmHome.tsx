...
export default function LwmHome() {
	return (
		<div className={`lg:pr-40 lg:pl-40 px-4 h-screen tracking-[0.02em] ${siteThemeColorTailwind}`}>
			<div className="bg-[url('/images/workoutHome.jpg')] bg-cover bg-center z-10 h-full overflow-y-auto scrollbar-hidden">
				...
				{Array.from({length: 1}).map((_, i) => (
					<div
						...
						<div className="pt-[100px]">Work in Progress...</div>
						<ChevronDown
							strokeWidth={1.2}
				...
				<div className="h-full text-white lg:text-8xl text-5xl bg-neutral-800 flex items-center text-opacity-20  justify-center ">Testimonials</div>
				<div className="h-full text-white text-5xl lg:text-8xl bg-neutral-700 flex items-center text-opacity-20  justify-center ">Contact</div>
			</div>
		</div>
	)
}
